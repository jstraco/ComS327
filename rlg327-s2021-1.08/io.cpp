...
void io_inspect_item(dungeon *d)
{
  ...
  {
  case '0':
    mvprintw(15, 5, (d->inventory[0]->get_description()));
    break;
  case '1':
    mvprintw(15, 5, (d->inventory[1]->get_description()));
    break;
  case '2':
    mvprintw(15, 5, (d->inventory[2]->get_description()));
    break;
  case '3':
    mvprintw(15, 5, (d->inventory[3]->get_description()));
    break;
  case '4':
    mvprintw(15, 5, (d->inventory[4]->get_description()));
    break;
  case '5':
    mvprintw(15, 5, (d->inventory[5]->get_description()));
    break;
  case '6':
    mvprintw(15, 5, (d->inventory[6]->get_description()));
    break;
  case '7':
    mvprintw(15, 5, (d->inventory[7]->get_description()));
    break;
  case '8':
    mvprintw(15, 5, (d->inventory[8]->get_description()));
    break;
  case '9':
    mvprintw(15, 5, (d->inventory[9]->get_description()));
    break;
  default:
