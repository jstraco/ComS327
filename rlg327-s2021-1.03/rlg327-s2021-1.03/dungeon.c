...
void place_monsters(dungeon_t *d)
{
  ...
  for (int i = 0; i < d->numMon; i++)
  {
    ...
    case 10:
      ...
      break;
    case 11:
      d->monsters[i].symbol = 'b';
      break;
    case 12:
      d->monsters[i].symbol = 'c';
      break;
    case 13:
      d->monsters[i].symbol = 'd';
      break;
    case 14:
      d->monsters[i].symbol = 'e';
      break;
    case 15:
    ...
    while (1)
    {
      ...
      if (!isValid || (d->pc.position[dim_x] == mon_x_pos && d->pc.position[dim_y] == mon_y_pos))
      {
        continue;
      }
